...
This walkthrough takes you from zero to a working mod that replaces the MENACE main-menu logo. [Next steps](#next-steps) at the end lists the other asset types and template patching.
