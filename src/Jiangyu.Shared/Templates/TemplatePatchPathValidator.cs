...
public static class TemplatePatchPathValidator
{
    ...
    private static bool IsSupportedValue(CompiledTemplateValue value, int depth)
    {
        ...
        return value.Kind switch
        {
            ...
            // when polymorphic. TypeConstruction uses the same shape with
            ...
            CompiledTemplateValueKind.TypeConstruction => IsSupportedComposite(value.TypeConstruction, depth, requireTypeName: false),
