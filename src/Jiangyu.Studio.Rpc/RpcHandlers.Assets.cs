...
public static partial class RpcHandlers
{
    ...
    internal static JsonElement AssetsIndexStatus(JsonElement? __)
    {
    ...
    internal static JsonElement AssetsSearch(JsonElement? parameters)
    {
    ...
    internal static JsonElement AssetsExport(JsonElement? parameters)
    {
    ...
    internal static JsonElement AssetsPreview(JsonElement? parameters)
    {
        var collection = RequireString(parameters, "collection");
        var pathId = RequireLong(parameters, "pathId");
