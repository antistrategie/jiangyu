...
import { PALETTE_SCOPE, useRegisterActions, type PaletteAction } from "@shared/palette/actions";
import { columnWeight, getActiveCodePane, paneWeight, type Layout } from "@features/panes/layout";
import { fileTargetCommands } from "@features/project/fileCommands";
...
import { parseCrossTabPayload, completeTabMove, CROSS_TAB_MIME } from "@features/panes/crossTab";
import {
  CROSS_PANE_MIME,
  completePaneMove,
  parseCrossPanePayload,
} from "@features/panes/crossPane";
import { isTemplateDragPayload } from "@features/templates/templateDrag";
import {
  PANE_DRAG_MIME,
  TAB_DRAG_MIME,
...
import { isBinaryFile } from "@features/editor/CodeEditor/fileTypes";
import { isUsefulMonacoAction } from "@features/editor/CodeEditor/monacoActionFilter";
